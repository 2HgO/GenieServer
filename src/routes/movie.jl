const movieRoutes = [
	...
	Endpoint(path="/:movieID", method=DELETE, handlerFuncs=(handlers.deleteMovie,), name=:delete_movie),
	Endpoint(path="", method=PUT, handlerFuncs=(handlers.createMovie,), name=:create_movie),
